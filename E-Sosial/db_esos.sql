...
CREATE TABLE `t_bidang` (
  ...
  `bidang_title` varchar(100) NOT NULL COMMENT 'judul bidang',
...
insert  into `t_news`(`news_id`,`user_id`,`news_date`,`news_title`,`news_content`,`news_status`,`news_modified`,`news_parent`,`news_type`,`news_url`,`news_category`) values (77,2,'2014-04-30 17:12:07','Lagi','awdwd','tidak_aktif','2014-04-30 17:12:07',0,'umum','Kosong',15),(78,2,'2014-04-30 17:12:07','Lagi','awdwd','aktif','2014-04-30 17:12:54',77,'umum','Kosong',16),(79,2,'2014-04-30 17:13:22','zzzz','awdawd','aktif','2014-04-30 17:13:22',0,'umum','Kosong',16),(74,2,'2014-04-21 17:52:11','uhuhu','awd','tidak_aktif','2014-04-21 17:52:11',0,'umum','Kosong',16),(75,2,'2014-04-21 17:52:11','uhuhu','<div align=\"center\">Coba</div>','aktif','2014-04-21 17:55:54',74,'umum','Kosong',16);
...
CREATE TABLE `t_seksi` (
  ...
  `user_id` int(11) NOT NULL COMMENT 'join ke t_user',
  `seksi_title` varchar(100) NOT NULL COMMENT 'judul',
...
insert  into `t_seksi`(`seksi_id`,`user_id`,`seksi_title`,`seksi_name`,`seksi_foto`,`seksi_description`,`seksi_date`,`seksi_desc_foto`,`bidang_id`) values (4,2,'Penyuluhan, pemberdayaan, dan partisipasi sosial','Yayah','~/Content/Image/p_yayah.jpg','<p style=\"text-align:justify\"><b>Tugas Pokok :</b></p>\r\n								\r\n                                <p style=\"text-align:justify\">Seksi \r\nPenyuluhan, Pemberdayaan dan Partisipasi Sosial mempunyai tugas pokok \r\nmelaksanakan sebagian tugas Bidang Partisipasi Sosial dan Masyarakat \r\nlingkup penyuluhan, pemberdayaan dan partisipasi sosial. </p>\r\n                                \r\n                                <br><br><br>\r\n                                <p style=\"text-align:justify\"><b>Fungsi :</b></p>\r\n                                \r\n								<p style=\"text-align:justify\">Untuk melaksanakan tugas pokok tersebut Seksi Penyuluhan, Pemberdayaan dan Partisipasi Sosial mempunyai fungsi: </p>\r\n                                <p style=\"text-align:justify\">a.	Pengumpulan dan penganalisaan data lingkup penyuluhan, pemberdayaan dan partisipasi sosial; </p>\r\n                                \r\n                                <p style=\"text-align:justify\">b.	Penyusunan bahan petunjuk teknis lingkup penyuluhan, pemberdayaan dan partisipasi sosial;  </p>\r\n                                \r\n                                <p style=\"text-align:justify\">c.	\r\nPelaksanaan lingkup penyuluhan, pemberdayaan dan partisipasi sosial yang\r\n meliputi penyuluhan, pembinaan dan pendayagunaan partisipan sosial, \r\nlembaga sosial, dan organisasi sosial kemasyarakatan dalam \r\npenyelenggaraan pembangunan sosial, pendayagunaan Potensi dan Sumber \r\nKesejahteraan Sosial PSKS), fasilitasi pemberian penghargaan di bidang \r\nsosial, serta pengembangan jaringan sistem informasi sosial; dan </p>\r\n                                \r\n                                <p style=\"text-align:justify\">d.	Evaluasi dan pelaporan pelaksanaan lingkup penyuluhan, pemberdayaan dan partisipasi sosial. </p>','2014-04-30 16:04:50','Kosong',15);
