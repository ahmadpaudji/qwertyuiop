...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="wrap">
        <div class="head">
            ...
            <div class="side fr">
                <%: Html.ActionLink("Tambah", "Create", "foto", new { @class = "btn btn-primary" })%>
            </div> 
            <div class="search">
            </div>
        </div>
                        ...
                        <div class="content np table-sorting">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="sortc">
                                ...
                                <tbody>
                                    ...
                                    <% int i = 1; foreach (var item in Model.Where(t => t.dokumentasi_type == "foto"))
                                       { %>
                                    <tr>
                                        <td align="center">
                                            <a class="fancybox" rel="group" href="<%: Url.Content(item.dokumentasi_path) %>"><img width="50" height="50" src="<%: Url.Content(item.dokumentasi_path) %>" class="img-polaroid"/></a>
                                        </td>
                                        <td>
