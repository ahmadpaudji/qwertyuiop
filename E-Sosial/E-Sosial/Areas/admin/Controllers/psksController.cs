...
{
    public class psksController : Controller
    {
        ...
        {
            var psks = from table in db.t_kesejahteraan
            ...
            return View(psks.ToList());
        }

        //
        // GET: /admin/psks/Details/5
