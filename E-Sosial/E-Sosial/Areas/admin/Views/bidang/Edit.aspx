<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/admin/Views/Shared/content.Master" Inherits="System.Web.Mvc.ViewPage<E_Sosial.Areas.admin.Models.BidangUpdate>" %>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="block">
                        ...
                        <% using (Html.BeginForm("Edit", "bidang", FormMethod.Post, new { enctype = "multipart/form-data" }))
                           { %>
                        <%: Html.ValidationSummary(true) %>
                        <%: Html.HiddenFor(model=>model.bidang_date) %>
                        <%: Html.HiddenFor(model=>model.bidang_id) %>
                        <%: Html.HiddenFor(model=>model.user_id) %>
                        <%: Html.HiddenFor(model=>model.gambar_pj) %>
                        <%: Html.HiddenFor(model=>model.gambar_des) %>
