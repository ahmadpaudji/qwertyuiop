            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="block">
                        ...
                        <% using (Html.BeginForm("Edit", "seksi", FormMethod.Post, new { enctype = "multipart/form-data" }))
                           { %>
                        <%: Html.ValidationSummary(true) %>
                        <%: Html.HiddenFor(model=>model.seksi_id) %>
                        <%: Html.HiddenFor(model=>model.seksi_date) %>
                        <%: Html.HiddenFor(model=>model.seksi_desc_foto) %>
                        <%: Html.HiddenFor(model=>model.seksi_foto) %>
